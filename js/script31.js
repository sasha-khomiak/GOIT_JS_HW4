...
// Доповни функцію isEveryUserActive(users) таким чином, щоб
// вона перевіряла, чи всі користувачі зараз активні(властивість isActive)
...
console.log(isEveryUserActive(users)); //повертає false
